...
export default {
    ...
    createUser: function (userData) {
        return axios.post("/api/user", userData, DEFAULT_HEADER);
    },

    // Gets all users
    getAllUsers: function () {
        return axios.get("/api/user", DEFAULT_HEADER);
    },

    // Gets the user with the given userId
    getUser: function (userId) {
        return axios.get(`/api/user/${userId}`, DEFAULT_HEADER);
    },

    // Updates the user with the given userId
    updateUser: function (userId, userData) {
        return axios.put(`/api/user/${userId}`, userData, DEFAULT_HEADER);
    },

    // Deletes the user with the given userId
    deleteUser: function (userId) {
        return axios.delete(`/api/user/${userId}`, DEFAULT_HEADER);
    },

    // Gets all shindigs for a user
    getAllShindigsForUser: function (userId) {
        return axios.get(`/api/user/${userId}/shindig`, DEFAULT_HEADER);
    },
    ...
    yelpBusiness: function (yelpId) {
        return axios.get(`/api/yelp/${yelpId}`, DEFAULT_HEADER)
    },
