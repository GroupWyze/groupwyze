        ...
        return (
            <div className="row">
                ...
                <div className="col s12 m8 l9">
                    <Categories onCategoriesChange={handleCategoryChange} categories={this.state.categories} shindigId={this.state.shindigId} location={this.state.address ? this.state.address : this.state.city + ", " + this.state.zip} />
                </div>
            </div>
        );
    }
